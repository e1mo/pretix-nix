...
let
  sources = {
    ...
    "@rollup/plugin-babel-6.0.3" = {
      ...
      version = "6.0.3";
      src = fetchurl {
        url = "https://registry.npmjs.org/@rollup/plugin-babel/-/plugin-babel-6.0.3.tgz";
  ...
  args = {
    ...
    packageName = "pretix";
    version = "0.0.0";
    src = ../../../nix/store/mibvrby3xa2ys2621v1rkh8hvs45a465-source/src/pretix/static/npm_dir;
    dependencies = [
      ...
      sources."@rollup/plugin-babel-6.0.3"
      sources."@rollup/plugin-node-resolve-15.0.1"
